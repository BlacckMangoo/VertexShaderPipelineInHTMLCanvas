...
function imageToRGBATexture(fileName, targetWidth = 512, targetHeight = 512) {
...
function downscaleTexture(texture, originalWidth, originalHeight, targetWidth, targetHeight) {
