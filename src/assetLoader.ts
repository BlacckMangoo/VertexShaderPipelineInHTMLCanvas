...
function imageToRGBATexture(fileName : string , targetWidth = 512, targetHeight = 512, strategy: downscaleStrategy = "Nearest") : Texture {
...
function downscaleTexture (texture : Uint8ClampedArray, originalWidth: number, originalHeight: number, targetWidth: number, targetHeight: number , strat : downscaleStrategy = "Nearest"): Uint8ClampedArray {
...
function generateTextureTS(textures: Array<{ exportName: string; texture: Texture }>): string {
    return [
